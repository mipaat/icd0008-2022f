...
public static class Utils
{
    ...
    {
        if (!enumType.IsEnum) throw new ArgumentException($"Argument {nameof(enumType)} must be an Enum, but was {enumType}");
    ...
    public static IEnumerable<SelectListItem> AiTypeOptions => EnumOptions(typeof(EAiType), new SelectListItem("No AI", ""));
